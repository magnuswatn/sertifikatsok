...
KNOWN_CERT_TYPES = {
    ...
    (CertType.BUSINESS, "Buypass TEST virksomhetssertifikat (softsertifikat)"),
    ...
    (CertType.BUSINESS, "Buypass TEST virksomhetssertifikat (smartkort)"),

    ("C=NO, O=Buypass AS-983163327, CN=Buypass Class 3 CA 3", "2.16.578.1.26.1.3.2"):
    (CertType.BUSINESS, "Buypass virksomhetssertifikat (softsertifikat)"),

    ("C=NO, O=Buypass AS-983163327, CN=Buypass Class 3 CA 3", "2.16.578.1.26.1.3.5"):
    (CertType.BUSINESS, "Buypass virksomhetssertifikat (smartkort)"),
    ...
    (CertType.BUSINESS, "Commfides virksomhetssertifikat"),
    ...
    (CertType.BUSINESS, "Commfides TEST virksomhetssertifikat"),
